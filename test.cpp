...
int main(){
    ...
    std::string onnx_path {"/home/jia/project/trt_infer/model/yolov7_3classes_fp16.onnx"};
    std::string trt_path {"/home/jia/project/trt_infer/model/yolov7_3classes_int8.engine"};
